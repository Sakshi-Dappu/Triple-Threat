        ...
        <>
          ...
          <div className="InfoCard">
           <li>Temperature:&nbsp;&nbsp;{data.days[0].temp} &nbsp;°C </li>
            ...
            <li>Sunrise at: &nbsp;&nbsp;{`${parseInt(data.days[0].sunrise.split(":")[0]) % 12 || 12}:${data.days[0].sunrise.split(":")[1]} ${parseInt(data.days[0].sunrise.split(":")[0]) >= 12 ? 'PM' : 'AM'}`}</li>
            <li>Sunset at:&nbsp; &nbsp; {`${parseInt(data.days[0].sunset.split(":")[0]) % 12 || 12}:${data.days[0].sunset.split(":")[1]} ${parseInt(data.days[0].sunset.split(":")[0]) >= 12 ? 'PM' : 'AM'}`}</li>
